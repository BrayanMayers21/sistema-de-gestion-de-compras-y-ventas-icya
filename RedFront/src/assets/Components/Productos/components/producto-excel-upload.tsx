...
interface ProductoExcelUploadProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess?: () => void;
}

export function ProductoExcelUpload({
  isOpen,
  onClose,
  onSuccess,
}: ProductoExcelUploadProps) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const result = await ProductosService.subirExcel(selectedFile);
      ...
      let mensaje = result.message || "Productos importados correctamente";
      ...
      if (result.debug) {
        ...
        console.log(
          ...
          result.debug.categorias_disponibles
        );
        console.log(
          "Encabezados encontrados:",
          result.debug.encabezados_encontrados
        );
      }
      ...
      // Mostrar trace si está disponible
  ...
  const handleDownloadTemplate = async () => {
    try {
      await ProductosService.descargarPlantillaExcel();
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Sube un archivo Excel con los productos/materiales para importarlos
            masivamente.
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 space-y-1">
                ...
                <ul className="text-xs text-amber-700 dark:text-amber-300 space-y-1 list-disc list-inside">
                  <li>
                    El archivo debe tener las columnas: Código, Nombre,
